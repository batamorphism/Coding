...
void create_bin_dat(std::string csv_path, std::string out_path, int r_end, int c_end) {
    ...
    while (std::getline(ifs, line)) {
        auto row = split(line, ',');
        for (int c = 0; c < row.size() && c < c_end; c++) {
...
int main() {
    auto csv_path = "D:\\Users\\Takanori\\Documents\\bunkakai\\dataset_large.csv";
    auto out_path = "D:\\Users\\Takanori\\Documents\\bunkakai\\dataset_large.bin";
    int r_end = 5000*1200;
    int c_end = 300;
    /*
