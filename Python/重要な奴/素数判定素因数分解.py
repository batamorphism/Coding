...
def main():
    c_prime = Prime(97)  # 2<= p < 97の素数について処理
    # エラトステネスの櫛を使用する必要がないときは、
    # c_prime = Prime(0)等と、小さい数値を入れる
    # 10**6くらいまでなら高速に動くので、適当に100010くらいを入れておいてもよい
    print(c_prime.prime_list)
    print(c_prime.get_a_prime_factor(6))  # 6の素因数 2
    print(c_prime.get_a_prime_factor(7))  # 素数の時は1
    print(c_prime.get_prime_factors(6))
    print(c_prime.get_prime_factors_of_list([6, 14]))
    print(c_prime.factorization(24))
    print(c_prime.is_prime(10**10+9))
